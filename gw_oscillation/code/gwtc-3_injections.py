...
#Detected injections
m1z_inj = m1z_mock_pop[snr_tot_obs_mock_pop>snr_th]
m2z_inj = m2z_mock_pop[snr_tot_obs_mock_pop>snr_th]
dL_inj = dL_mock_pop[snr_tot_obs_mock_pop>snr_th]
p_draw_inj = p_draw_mock_pop[snr_tot_obs_mock_pop>snr_th]
