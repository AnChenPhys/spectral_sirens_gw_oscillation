...
#Save data
###########
np.save(dir_out+'m1z_'+obs+'_Ndet_%s_Nsamples_%s_'% (n_detections,n_samples)+model_name,m1z_mock_samples)
np.save(dir_out+'m2z_'+obs+'_Ndet_%s_Nsamples_%s_'% (n_detections,n_samples)+model_name,m2z_mock_samples)
np.save(dir_out+'dL_'+obs+'_Ndet_%s_Nsamples_%s_'% (n_detections,n_samples) +model_name,dL_mock_samples)
np.save(dir_out+'pdraw_'+obs+'_Ndet_%s_Nsamples_%s_'% (n_detections,n_samples)+model_name,pdraw_mock_samples)
