...
def log_lik(m1z_mock_samples,m2z_mock_samples,dL_mock_samples,pdraw_mock_samples,m1z_inj,m2z_inj,dL_inj,p_draw_inj,Ndraw,Tobs,z_test,param_bound,PC_params=None):
    ...
    log_Ndet = jax.scipy.special.logsumexp(log_dN_inj - jnp.log(p_draw_inj)) - jnp.log(Ndraw)
    
    #Effective number of samples
    log_N2 = jax.scipy.special.logsumexp(2.0*log_dN_inj - 2.0*jnp.log(p_draw_inj)) - 2.0*jnp.log(Ndraw)
